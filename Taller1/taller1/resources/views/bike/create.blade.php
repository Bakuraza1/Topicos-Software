...
@endsection
@section('textTitle')
   Complete this form to add a bike
@endsection
@section('content')
   <div id="create_container">
      ...
      <div id="form_container">
         <form method="POST" id="bike_create_form" enctype="multipart/form-data" action="{{ route('bike.save') }}">
            @csrf
            ...
            <div id="form_input_container">
               ...
               <input type="hidden" name="shareable"  value="0"><input type="checkbox" class="bike_create_check" onclick="this.previousSibling.value=1-this.previousSibling.value">
            </div>
